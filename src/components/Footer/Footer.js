                    ...
                    <div className='col-12 col-md-6'>
                        ...
                        <ul>
                            <li>
                                <FaChevronRight />{' '}
                                <Button
                                    path={t('nav.home.link')}
                                    text={t('nav.home.title')}
                                    asLink
                                    buttonType={'link'}
                                />
                            </li>
                            <li>
                                <FaChevronRight />
                                <Button
                                    path={t('nav.about.link')}
                                    text={t('nav.about.title')}
                                    asLink
                                    buttonType={'link'}
                                />
                            </li>
                            <li>
                                <FaChevronRight />
                                <Button
                                    path={t('nav.terms.link')}
                                    text={t('nav.terms.title')}
                                    asLink
                                    buttonType={'link'}
                                />
                            </li>
                            <li>
                                <FaChevronRight />
                                <Button
                                    path={t('nav.policy.link')}
                                    text={t('nav.policy.title')}
                                    asLink
                                    buttonType={'link'}
                                />
                            </li>
                    ...
                    <div className='col-12 col-md-6'>
                        ...
                        <ul>
                            <li>
                                <FaChevronRight />{' '}
                                <Button
                                    path={t('nav.test.link')}
                                    text={t('nav.test.title')}
                                    asLink
                                    buttonType={'link'}
                                />
                            </li>
