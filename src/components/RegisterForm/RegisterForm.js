    ...
    <div className={`${styles.container} col-12 col-md-6 col-lg-5 col-xl-4 col-xxl-3`}>
      ...
      <div className="d-flex flex-column justify-content-center align-items-center w-100">
        ...
        <form onSubmit={handleSubmit} className="d-flex flex-column justify-content-center align-items-center w-100">
          ...
          <TextInput type="password" placeholder="Repeat password" variant="login" handleChange={handleRepeatPasswordChange} classes="w-100" />
          <TextInput type="text" placeholder="Name" variant="login" handleChange={handleNameChange} classes="w-100" />
          <TextInput type="text" placeholder="Lastname" variant="login" handleChange={handleLastNameChange} classes="w-100" />
