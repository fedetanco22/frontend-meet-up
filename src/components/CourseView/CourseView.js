    ...
    <Card styleClass="px-3">
      ...
      <div className="d-flex flex-wrap border-bottom">
        ...
        {user?.data?.role === "Administrator" || user?.data?.role_id === 1 ? (
          <div className="col-12 col-md-4 col-lg-3 col-xxl-2 d-flex flex-column align-items-stretch my-3 p-3">
            ...
            <Button path={"./course-edit"} buttonType="light" className="mt-1" asSubmit callback={handleShow} text={t("deleteCourse")}>
              <FaTrashAlt />
            </Button>
          </div>
        ) : null}
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Footer>
          ...
          <Button text={t("modal.delete")} buttonType={"light"} callback={deleteCourse} asSubmit>
            <FaTrashAlt />
          </Button>
        </Modal.Footer>
      </Modal>
