...
import { FaPencilAlt, FaTrashAlt, FaUsers } from 'react-icons/fa';
    ...
    if (roleSelected === '0') {
      if (inputText.length === 0) {
        ...
        setUsersFilters(
          users.filter(
            (e) =>
              e.last_name.toLowerCase().match(inputText.toLowerCase()) ||
              e.name.toLowerCase().match(inputText.toLowerCase())
          )
        );
      }
    } else {
